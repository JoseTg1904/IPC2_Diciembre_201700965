...
class orden extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get("http://localhost:4000/Crear_Bien").then(res1 => {
            ...
            for (var i = 0; i < res1.data.length; i++) {
                if (res1.data[i]['tipo'] === "Almuerzo" && res1.data[i]['restante']>0 ) {
    ...
    obtenerDatos(e) {
        ...
        axios.post( "http://localhost:4000/Entregas/almuerzo" , {
            ...
            if (res.data === 1000) {
                ...
                alert('el estudiante ya a recibido el almuerzo del dia')
            }
        })
            e.preventDefault();
    }
                        ...
                        <div className="card-body">
                            <form onSubmit={this.obtenerDatos}>
                                <fieldset>
                                    ...
                                    <div className="form-group mx-auto">
                                        <label htmlFor="bien">Almuerzo</label>
                                        <select className="form-control"
                                            id="bien">{
